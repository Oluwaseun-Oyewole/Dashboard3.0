              ...
              return (
                <SwiperSlide key={index}>
                  <div
                    ...
                    } flex flex-col  w-full md:w-[170px] lg:w-[200px] min-h-[200px] pt-7 pb-5 px-4 rounded-lg justify-between hover:scale-105 transition-all ease-in-out duration-500 cursor-pointer`}
                  >
